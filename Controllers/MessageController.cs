...
namespace Project.Controllers
{
    public class MessageController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Msg")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Msg")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
